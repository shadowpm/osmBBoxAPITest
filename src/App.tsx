  ...
  return (
    <div className="App">
      <form onSubmit={handleSubmit}>
        <LabelledInput inputLabel="Westernmost longitude:" inputName="left" inputValue={state.left} onInputChange={handleInputChange} hasError={!isValidLongitude(state.left)} />
        <LabelledInput inputLabel="Southernmost latitude:" inputName="bottom" inputValue={state.bottom} onInputChange={handleInputChange} hasError={!isValidLatitude(state.bottom)} />
        <LabelledInput inputLabel="Easternmost longitude:" inputName="right" inputValue={state.right} onInputChange={handleInputChange} hasError={!isValidLongitude(state.right)} />
        <LabelledInput inputLabel="Northernmost latitude:" inputName="top" inputValue={state.top} onInputChange={handleInputChange} hasError={!isValidLatitude(state.top)} />
